...
class ProjectControllerTest {
	...
	void getProjects_withCompanyId_returnsFilteredProjects() throws Exception {
		...
		org.mockito.Mockito.when(clientService.listProjects(1L)).thenReturn(List.of(project1));
	...
	void getProjects_withoutCompanyId_returnsAllProjects() throws Exception {
		...
		org.mockito.Mockito.when(clientService.listProjects(null)).thenReturn(List.of(project1, project2));
