...
class EmployeeControllerTest {
	...
	void getAllEmployees_returnsOkWithJsonArray() throws Exception {
		EmployeeListDto emp1 = new EmployeeListDto(
				1L, "Jane Doe", "jane@acme.com", "Software Engineer", null,
				new NextScheduledDto("2025-03-15", "CHECK_IN"));
		EmployeeListDto emp2 = new EmployeeListDto(
				2L, "John Wick", "john@acme.com", "Team Lead", null, null);

		when(employeeService.listAll()).thenReturn(List.of(emp1, emp2));
