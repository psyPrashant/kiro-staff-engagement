...
class SchedulingIntegrationTest extends BaseIntegrationTest {
	...
	void listScheduledInteractions_overdueTrue_returnsOnlyOverduePendingItems() {
		...
		overdue.setInteractionType(com.psybergate.staff_engagement.interaction.InteractionType.CHECK_IN);
		...
		futurePending.setInteractionType(com.psybergate.staff_engagement.interaction.InteractionType.MENTORING);
		...
		pastCompleted.setInteractionType(com.psybergate.staff_engagement.interaction.InteractionType.CATCH_UP);
