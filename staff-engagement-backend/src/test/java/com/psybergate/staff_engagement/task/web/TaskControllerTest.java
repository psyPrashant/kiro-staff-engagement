...
class TaskControllerTest {
	...
	void getAllTasks_returnsOkWithJsonArray() throws Exception {
		...
		org.mockito.Mockito.when(taskService.listAll()).thenReturn(List.of(task1, task2));
	...
	void getAllTasks_returnsTasksWithEmployeeFieldsPopulatedAndNull() throws Exception {
		...
		when(taskService.listAll()).thenReturn(List.of(taskWithEmployee, taskWithoutEmployee));
